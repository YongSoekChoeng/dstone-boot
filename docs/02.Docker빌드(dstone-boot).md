...
## <span style="color:green;">1. 컨테이너 구성 개요</span>
...
## <span style="color:green;">2. 사전 작업</span>
...
## <span style="color:green;">3. WSL 호스트 디렉토리 구조</span>
...
## <span style="color:green;">4. 사전작업</span>
...
## <span style="color:green;">5. 작업 명령 – 일괄 실행 (docker-compose.yml)</span>
...
## <span style="color:green;">6. 작업 명령 – 개별 실행 (서비스별 docker yml)</span>
...
## <span style="color:green;">7. Docker Hub 이미지 등록</span>
...
## <span style="color:green;">8. 정리</span>
