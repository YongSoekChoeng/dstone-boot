...
/**********************************************
Analyze 데이터베이스[Application용] 테이블
**********************************************/

USE analyzeDB;

CREATE TABLE IF NOT EXISTS TB_SYS ( 
...
CREATE TABLE IF NOT EXISTS TB_CLZZ ( 
  SYS_ID VARCHAR(20) NOT NULL COMMENT '시스템ID', 
...
CREATE TABLE IF NOT EXISTS TB_TBL ( 
  SYS_ID VARCHAR(20) NOT NULL COMMENT '시스템ID', 
...
CREATE TABLE IF NOT EXISTS TB_FUNC_FUNC_MAPPING ( 
  SYS_ID VARCHAR(20) NOT NULL COMMENT '시스템ID', 
  FUNC_ID VARCHAR(300) NOT NULL COMMENT '기능ID', 
...
CREATE TABLE IF NOT EXISTS TB_FUNC_TBL_MAPPING ( 
  SYS_ID VARCHAR(20) NOT NULL COMMENT '시스템ID', 
  FUNC_ID VARCHAR(300) NOT NULL COMMENT '기능ID', 
  TBL_ID VARCHAR(100) NOT NULL COMMENT '테이블ID', 
...
CREATE TABLE IF NOT EXISTS TB_UI ( 
  SYS_ID VARCHAR(20) NOT NULL COMMENT '시스템ID', 
...
CREATE TABLE IF NOT EXISTS TB_UI_FUNC_MAPPING ( 
  SYS_ID VARCHAR(20) NOT NULL COMMENT '시스템ID', 
  UI_ID VARCHAR(100) NOT NULL COMMENT '화면ID', 
...
CREATE TABLE IF NOT EXISTS TB_METRIX ( 
