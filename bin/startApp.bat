...
set SCOUTER_OPTS=-javaagent:"C:\WorkShop\D\AppHome\framework\dstone-boot\WorkShop\03.Tools\02.Scouter\scouter\agent.java\scouter.agent.jar"
set SCOUTER_OPTS=%SCOUTER_OPTS% -Dscouter.config="C:\WorkShop\D\AppHome\framework\dstone-boot\WorkShop\03.Tools\02.Scouter\scouter\agent.java\conf\scouter.conf"
