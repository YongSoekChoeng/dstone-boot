		...
		private void genTestSrcForJsp(int CRUD, String strTableName, String strPrefix, String strUri, String strVoPackageName, String strVoName, boolean pageYn) {
			...
			try {
				...
				if (CRUD == 0) {
					...
					buff.append("String                                                         successYn;                                       ").append("\n");
					...
					buff.append("successYn           = net.dstone.common.utils.StringUtil.nullCheck(response.getHeader(\"successYn\"), \"\");			").append("\n");
					...
					buff.append("        <%                                                                                                       ").append("\n");
					buff.append("        if( successYn != null ){                                                                                 ").append("\n");
					buff.append("            if(successYn.equals(\"Y\")){                                                                                   ").append("\n");
					buff.append("        %>	                                                                                                     ").append("\n");
		...
		private void genTestSrcForJson(int CRUD, String strTableName, String strPrefix, String strUri, String strVoPackageName, String strVoName, boolean pageYn) {
			...
			try {
				...
				if (CRUD == 0) {
					...
					buff.append("                var successYn = request.getResponseHeader('successYn'); ").append("\n");
					buff.append("                var errCd = request.getResponseHeader('errCd'); ").append("\n");
					buff.append("                var errMsg = decodeURIComponent(request.getResponseHeader('errMsg')); ").append("\n");
					buff.append("                if( 'Y' == successYn ){ ").append("\n");
					...
					buff.append("                    alert(\"failure errMsg:\" + errMsg); ").append("\n");
					buff.append("                } ").append("\n");
					buff.append("            }, ").append("\n");
