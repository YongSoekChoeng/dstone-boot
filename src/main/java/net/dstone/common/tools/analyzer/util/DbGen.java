...
public class DbGen {
	...
	public static class DDL {
		...
		static {
			...
			/* <펑션-FN_FUNC_FUNC_MAPPING> */
			ORACLE_FUNCTION.append("CREATE OR REPLACE FUNCTION FN_FUNC_FUNC_MAPPING(V_FUNC_ID IN VARCHAR2, V_RECURSIVE_YN IN VARCHAR2) RETURN CLOB").append("\n");
			ORACLE_FUNCTION.append("IS").append("\n");
			ORACLE_FUNCTION.append("	RETURN_CALL_CHAIN CLOB;").append("\n");
			ORACLE_FUNCTION.append("	CALL_CHAIN_UNIT VARCHAR2(4000);		").append("\n");
			...
			/* <펑션-FN_FUNC_TBL_MAPPING> */
			ORACLE_FUNCTION.append("CREATE OR REPLACE FUNCTION FN_FUNC_TBL_MAPPING(V_FUNC_ID IN VARCHAR2, V_RECURSIVE_YN IN VARCHAR2) RETURN CLOB").append("\n");
			ORACLE_FUNCTION.append("IS").append("\n");
			ORACLE_FUNCTION.append("	RETURN_CALL_CHAIN CLOB;").append("\n");
			ORACLE_FUNCTION.append("	CALL_CHAIN_UNIT VARCHAR2(4000);		").append("\n");
			ORACLE_FUNCTION.append("BEGIN").append("\n");
