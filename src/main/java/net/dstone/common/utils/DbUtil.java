...
//		}
	...
	public static net.dstone.common.utils.DataSet getTabs(String DBID, String TABLE_NAME_LIKE_STR) {
		...
		try {
			...
			if ("ORACLE".equals(db.currentDbKind)) {
				...
				if(!StringUtil.isEmpty(TABLE_NAME_LIKE_STR)) {
					sql.append("		AND A.TABLE_NAME LIKE '"+TABLE_NAME_LIKE_STR+"%' ").append("\n");
				}
				sql.append("	) A ").append("\n");
				sql.append("WHERE 1=1 ").append("\n");
