...
public class UserDao extends net.dstone.common.biz.BaseDao { 
    ...
    public int listUserCount(net.dstone.sample.vo.UserVo userVo) throws Exception { 
        Object returnObj = sqlSessionSampleOracle.selectOne("net.dstone.sample.UserDao.listUserCount", userVo); 
        if (returnObj == null) {
            return 0;
        } else {
    ...
    public List<net.dstone.sample.vo.UserVo> listUser(net.dstone.sample.vo.UserVo userVo) throws Exception { 
        List<net.dstone.sample.vo.UserVo> list = sqlSessionSampleOracle.selectList("net.dstone.sample.UserDao.listUser", userVo); 
        return list; 
    } 
