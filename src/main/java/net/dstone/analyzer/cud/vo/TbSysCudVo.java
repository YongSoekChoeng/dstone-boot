...
@XmlRootElement( name="TbSysCudVo" ) 
public class TbSysCudVo extends net.dstone.common.biz.BaseVo implements java.io.Serializable { 
	@JsonProperty("SYS_ID") 
	...
	private String INCLUDE_PACKAGE_ROOT; 
	@JsonProperty("EXCLUDE_PACKAGE_PATTERN") 
	private String EXCLUDE_PACKAGE_PATTERN; 
	...
	public String getINCLUDE_PACKAGE_ROOT() {
		return INCLUDE_PACKAGE_ROOT;
	}
	public void setINCLUDE_PACKAGE_ROOT(String iNCLUDE_PACKAGE_ROOT) {
		INCLUDE_PACKAGE_ROOT = iNCLUDE_PACKAGE_ROOT;
	}
	public String getEXCLUDE_PACKAGE_PATTERN() {
		return EXCLUDE_PACKAGE_PATTERN;
	}
	public void setEXCLUDE_PACKAGE_PATTERN(String eXCLUDE_PACKAGE_PATTERN) {
