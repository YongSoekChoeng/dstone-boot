						...
						<div class="row main-row">
							...
							<div class="col-6 col-12-medium">
								...
								<section>
									...
									<ul class="big-image-list">
										<li>
											<a href="#"><img src="<%=requestUtil.getStrContextPath()%>/analyzer/images/pic3.jpg" alt="" class="left" /></a>
										...
										<li>
											<a href="#"><img src="<%=requestUtil.getStrContextPath()%>/analyzer/images/pic4.jpg" alt="" class="left" /></a>
											<h3>Magna Gravida Dolore</h3>
											<p>Varius nibh. Suspendisse vitae magna eget et amet mollis justo
											facilisis amet quis consectetur in, sollicitudin vitae justo. Cras
											Maecenas eu arcu purus, phasellus fermentum elit.</p>
										...
										<li>
											<a href="#"><img src="<%=requestUtil.getStrContextPath()%>/analyzer/images/pic5.jpg" alt="" class="left" /></a>
											<h3>Magna Gravida Dolore</h3>
											<p>Varius nibh. Suspendisse vitae magna eget et amet mollis justo
											facilisis amet quis consectetur in, sollicitudin vitae justo. Cras
											Maecenas eu arcu purus, phasellus fermentum elit.</p>
							...
							<div class="col-6 col-12-medium">
								...
								<article class="blog-post">
									...
									<a href="#"><img src="<%=requestUtil.getStrContextPath()%>/analyzer/images/pic6.jpg" alt="" class="top blog-post-image" /></a>
									<h3>Magna Gravida Dolore</h3>
